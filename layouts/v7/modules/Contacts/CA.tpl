...
<body>
    {if !isset($smarty.request.PDFDownload) || $smarty.request.PDFDownload neq true}
        <ul style="list-style-type:none;margin:0;padding:0;overflow:hidden;background-color:#333;">
            ...
            {assign var="transactionWarningExcludes" value=["voucher_type", "description", "grand_total", "matched_amt", "currency"]}
        ...
        <div class="printAreaContainer">
            <div class="full-width">
                ...
                <div style="margin-top: 6mm;">This Collection Acknowledgement is subject to and governed by the terms and
                    conditions of Form A. The liability of GPM in respect to the Stored Metal to be collected from the Storage
                    Facility
