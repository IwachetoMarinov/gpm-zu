        ...
        <ul style="list-style-type: none;
            ...
            <li style="float:right">
                <a style="display: block;color: white;text-align: center;padding: 14px 16px;text-decoration: none;background-color: #bea364;"
                    href="index.php?module=Contacts&view=DocumentPrintPreview&record={$RECORD_MODEL->getId()}&docNo={$smarty.request.docNo}&PDFDownload=true&bank={$SELECTED_BANK->getId()}">Download</a>
            </li>
                ...
                <tr>
                    <td style="font-size: 9pt; height: 168mm; vertical-align: top;">
                        ...
                        <table class="activity-tbl">
                            ...
                            <tr>
                                <td style="height:70mm;border-bottom:none;vertical-align: top">Storage charge for the
                                    period from {$ERP_DOCUMENT['fromDate']} to {$ERP_DOCUMENT['toDate']}:<br>
                                    &nbsp;&nbsp;&nbsp;&nbsp;{$ERP_DOCUMENT['metal']}
