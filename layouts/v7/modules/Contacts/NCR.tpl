...
<head>
    ...
    <style>
        {include file='PrintStyles.tpl'|vtemplate_path:'Contacts' print_layout='form_ncr'}
    </style>
</head>
    ...
    {for $page=1 to $PAGES}
        ...
        <div
                            ...
                            {if $PAGES eq $page}
                                <tr>
                                    <td style="width:100%;" colspan="4">
                                        {if isset($smarty.request.PDFDownload) || $smarty.request.PDFDownload eq true}
                                            <input type="text" name="total_value" style="width:35mm; border:0; font-weight:bold;" />
            ...
            <span style="display: inline-block; margin-top: 2mm;">
                ...
                be
                extended
                to any other services covered under Form A
            </span>
            ...
            <div style="margin-top: 3.5mm;">This Collection Order is subject to and governed by the terms and conditions
                of Form A executed and entered into by and between me/us and {if isset($COMPANY)}
