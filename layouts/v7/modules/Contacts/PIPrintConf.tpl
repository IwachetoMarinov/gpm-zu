...
<div id="myModal" class="modal">
    ...
    <div class="modal-content">
        ...
        <span style="margin-top: 10px; display:block">WKIN Invoice : <input type="checkbox" id="wkinInvoice"
                name="wkinInvoice" {if $wkinInvoice eq '1' || $wkinInvoice eq 1}value="1" checked
                {else}value="0"
                {/if}></span>
        <br>
