...
class Contacts_ViewCR_View extends Vtiger_Index_View
{
    ...
    public function process(Vtiger_Request $request)
    {
        ...
        $viewer->assign('transactionWarningExcludes', ContactsHelper::getCrTransactionWarningExcludes());
        $viewer->assign('barItemWarningExcludes', ContactsHelper::getCrBarItemWarningExcludes());
    ...
    function downloadPDF($html, Vtiger_Request $request)
    {
        ...
        $fileName = SimplePdfDownload::fileNameTemplateYear($clientID, 'CR', (string) $request->get('docNo'));
